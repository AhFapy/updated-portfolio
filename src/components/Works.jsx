...
const testimonios = [
  {
    ...
    texto: "Lidia es una profesional increíble. Desde el primer momento me hizo sentir cómoda y segura. Supo asesorarme y el tratamiento está siendo perfecto, mi pelo ha cambiado mucho desde que estoy en sus manos incluso mejor de lo que imaginaba, ¡ME ENCANTA! Recomendado 100% para tod@s l@s que les apetezca un cambio.",
  },
  {
    nombre: "Mónica Vigo",
    texto: "No me han tratado así de bien en la vida. Lidia me asesoró desde el principio y me explicó el proceso. Me ayudó a recuperar mi melena sana y con brillo. El ambiente fue súper agradable y el masaje de cabeza… el mejor del mundo. ¡Gracias Lidia!",
  },
  {
    nombre: "Mercedes Gutiérrez",
    texto: "Estoy encantada con la peluquería. Me ha atendido Chema la mayoría de las veces (y una vez Lidia) y noto mi pelo mucho más sano y bonito. Además, hay muy buen ambiente y el tiempo allí se pasa volando.",
  },
  {
    nombre: "Ilda Ventura Figueira",
    texto: "Sin duda la mejor peluquería de Madrid y con los mejores profesionales. Excelente trato y resultados. 100% recomendable. Os deseo mucho éxito.",
  },
]
...
const faqsPeluqueria = [
  {
    ...
    respuesta: "Claro, puedes venir solo a peinarte, cortarte o hacerte color. Pero siempre comenzamos con un diagnóstico para asegurarnos de que elegimos lo mejor para tu cabello.",
  },
  {
    pregunta: "¿Trabajáis con productos naturales?",
    respuesta: "Sí, priorizamos el uso de barros y técnicas respetuosas con tu salud y el medio ambiente.",
  },
]
...
const faqsAsesoria = [
  {
    ...
    respuesta: "Empezamos con un diagnóstico personalizado. No necesitas saber nada. Solo estar abierta al cambio.",
  },
  {
    pregunta: "¿Esto es solo para mujeres jóvenes?",
    respuesta: "No. Nuestro método se adapta a cualquier edad, etapa o estilo de vida.",
  },
  {
    pregunta: "¿Tengo que cambiar todo mi armario?",
    respuesta: "No. Te ayudamos a usar lo que ya tienes y solo sumar si es necesario.",
  },
]
        ...
        {faqsPeluqueria.map((item, index) => (
          <motion.div key={index} variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
            <Tilt
              ...
              className="bg-white p-6 rounded-2xl sm:w-[360px] w-full shadow-md"
            >
